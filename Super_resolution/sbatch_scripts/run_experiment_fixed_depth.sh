...
EXPERIMENT_ROOT="$(cd "$SCRIPT_DIR/.." && pwd)/experiments/experiment_1_constant_depth_3"
LOG_BASE="$EXPERIMENT_ROOT/logs"
MODEL_BASE="$EXPERIMENT_ROOT/models"
META_BASE="$EXPERIMENT_ROOT/metadata"
