...
def main():
    ...
    plot_training_curves(data_dir_exp1, 'Experiment 1', 'loss', 'Training Loss', 'Training Loss vs Epoch', 'exp1_loss_vs_epoch.pdf')
    plot_training_curves(data_dir_exp1, 'Experiment 1', 'val_psnr', 'PSNR (dB)', 'Validation PSNR vs Epoch', 'exp1_psnr_vs_epoch.pdf')
    plot_runtime_vs_scale(data_dir_exp1, 'Experiment 1', 'exp1_runtime_vs_scale.pdf')
    plot_psnr_vs_scale_eval(data_dir_exp1, 'Experiment 1', 'exp1_eval_psnr_vs_scale.pdf')
    
    print("\nGenerating Experiment 2 Plots...")
    plot_training_curves(data_dir_exp2, 'Experiment 2', 'loss', 'Training Loss', 'Training Loss vs Epoch', 'exp2_loss_vs_epoch.pdf')
    plot_training_curves(data_dir_exp2, 'Experiment 2', 'val_psnr', 'PSNR (dB)', 'Validation PSNR vs Epoch', 'exp2_psnr_vs_epoch.pdf')
    plot_runtime_vs_scale(data_dir_exp2, 'Experiment 2', 'exp2_runtime_vs_scale.pdf')
    plot_psnr_vs_scale_eval(data_dir_exp2, 'Experiment 2', 'exp2_eval_psnr_vs_scale.pdf')
