...
def train(args: argparse.Namespace) -> None:
    high_res_dir = Path(args.high_res_dir)
    ...
    ckpt_path = os.path.join(
        args.model_dir, f"unet_adaptive_scale{args.scale:.2f}_depth{info['depth']}.keras"
    )
    ...
    callbacks = [
        ...
        BackupAndRestore(os.path.join(args.model_dir, "train_backup")),
    ]
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--high_res_dir", type=str, default="dataset/Raw Data/high_res", help="Directory with HR images.")
    parser.add_argument("--low_res_dir", type=str, default=None, help="Optional directory with LR images; defaults to synthetic degradation.")
    ...
    parser.add_argument("--limit", type=int, default=None, help="Optional max number of HR images to load.")
